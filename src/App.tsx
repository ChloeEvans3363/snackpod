...
function App({ signOut, user }: WithAuthenticatorProps) {
  ...
  async function addNewImageToSong(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      // Add the file association to the record:
      const response = await client.models.Podcast.update({
        id: currentSong.id,
        coverArtPath: result?.path,
      });
  ...
  async function getImageForCurrentSong() {
    ...
    try {
      ...
      const response = await client.models.Podcast.get({
        id: currentSong.id,
      });
  ...
  async function removeImageFromSong() {
    ...
    try {
      ...
      const updatedSong = await client.models.Podcast.update({
        id: song.id,
        coverArtPath: null,
      });
  ...
  async function deleteCurrentSongAndImage() {
    ...
    try {
      ...
      await client.models.Podcast.delete({ id: song.id });
